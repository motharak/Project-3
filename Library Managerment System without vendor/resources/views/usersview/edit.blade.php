...
<form class="row g-3" method="POST" action="{{route('user.update',$user->user_id)}}">
    @csrf
    @method("PUT")
    <div class="col-md-6">
      <label for="" class="form-label">UserName</label>
      <input type="text" class="form-control" id="" required="" name='username' value="{{$user->username}}">
    </div>
    <div class="col-md-6">
  ...
  if (x.type === "password") {
    ...
    <div class="col-md-12">
        ...
        <select class="form-select" name="role" select="{{$user->role}}">
